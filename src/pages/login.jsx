      ...
      <div className="w-full max-w-[1000px] flex flex-col md:flex-row bg-base-100 rounded-lg overflow-hidden border border-base-200 shadow-sm relative">
        ...
        <div className="md:w-1/2 p-8 md:p-12">
          ...
          <div className="text-center mb-8 relative">
            ...
            <p className="text-base-content/60 mt-1">เข้าสู่ระบบเพื่อใช้งาน</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <div className="pt-2">
              <button
                type="button"
                className="btn bg-[#3b3a9e] hover:bg-[#2b2a75] text-white border-none w-full rounded-md shadow-sm"
              >
                เข้าสู่ระบบ
              </button>
            </div>
            ...
            <button
              type="button"
              className="btn btn-outline border-base-200 hover:bg-base-200 hover:border-base-300 bg-white w-full rounded-md shadow-[0_2px_10px_rgba(0,0,0,0.05)] mx-auto max-w-[90%] flex justify-center items-center gap-2 text-gray-700 hover:text-gray-900"
            >
              <svg
                viewBox="0 0 24 24"
                width="20"
            ...
            <p className="text-sm text-center mt-6 text-base-content/70">
              ...
              <Link
                to="/register"
                className="link link-primary ml-1 text-[#3b3a9e] no-underline hover:underline"
              >
                สมัครสมาชิก
              </Link>
            </p>
